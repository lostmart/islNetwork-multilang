	...
	<nav class="navbar navbar-expand-lg navbar-light bg-primary fixed-top">
		<div class="container">
			<router-link to="/" class="navbar-brand text-white">
				<img src="../assets/images/godparents-logo.png" alt="padrinos sin limites" />
			</router-link>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item">
						<router-link class="nav-link text-white" aria-current="page" to="/">{{ NavBarData.home }}
						</router-link>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item">
						<a class="nav-link text-white" href="mailto: ruralgodparents@gmail.com">{{ NavBarData.contact
							}}</a>
					</li>
					<li class="nav-item">
