...
<template>
	<div class="row container">
		...
		<div class="col-md-6 col-lg-4" v-for="member in teamData.teamMembers" :key="member.userName">
			<TeamMember class="m-4" :title="member.userName" :description="member.description" :imgUrl="member.imgUrl"
				:linkedIn="member.linkedIn" :rol="member.rol" />
		</div>
	</div>
</template>
